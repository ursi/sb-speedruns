...
var $author$project$Main$Model = F2(
	function (bossOnly, zone) {
		return {bossOnly: bossOnly, zone: zone};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2($author$project$Main$Model, true, 'FF'),
...
var $author$project$Css$Internal$function = F2(
	function (name, a) {
		return name + ('(' + (a + ')'));
	});
var $author$project$Css$nthChild = F2(
	function (a, b) {
		return $author$project$Css$mapSelector(
			$author$project$Css$append(
				A2(
					$author$project$Css$Internal$function,
					':nth-child',
...
var $author$project$Design$tableRadius = '.7em';
...
var $author$project$Html$Styled$addClass = A2(
	$elm$core$Basics$composeL,
	A2($elm$core$Basics$composeL, $elm$core$List$cons, $elm$html$Html$Attributes$class),
	$elm$core$Basics$append('_'));
...
var $author$project$Css$Internal$seed = 0;
...
var $author$project$Css$Internal$joinMap = F3(
	function (f, sep, list) {
		if (list.b) {
			if (!list.b.b) {
				var only = list.a;
				...
				return _Utils_ap(
					...
					_Utils_ap(
						sep,
						A3($author$project$Css$Internal$joinMap, f, sep, rest)));
			}
		} else {
			return '';
		}
	});
var $author$project$Css$Internal$tmpClass = '!@#$%^&*()';
var $author$project$Css$Internal$toPairsDictFrom = F2(
	function (pairsDict, declarations) {
		toPairsDictFrom:
		while (true) {
			if (declarations.b) {
				...
				if (first.$ === 'Single') {
					var classToSelector = first.a;
					var property = first.b;
					var value = first.c;
					var selector = classToSelector($author$project$Css$Internal$tmpClass);
					var $temp$pairsDict = A3(
						$elm$core$Dict$insert,
						selector,
						function () {
							var _v2 = A2($elm$core$Dict$get, selector, pairsDict);
							if (_v2.$ === 'Just') {
								var pairs = _v2.a;
								return A2(
									$elm$core$List$cons,
									_Utils_Tuple2(property, value),
									pairs);
							} else {
								return _List_fromArray(
									[
					...
					pairsDict = $temp$pairsDict;
					declarations = $temp$declarations;
					continue toPairsDictFrom;
				} else {
					var declarations_ = first.a;
					return A2(
						$author$project$Css$Internal$toPairsDictFrom,
						pairsDict,
						_Utils_ap(declarations_, rest));
				}
			} else {
				return pairsDict;
			}
...
var $author$project$Css$Internal$toPairsDict = $author$project$Css$Internal$toPairsDictFrom($elm$core$Dict$empty);
var $author$project$Css$Internal$toString = function (declarations) {
	return $elm$core$List$isEmpty(declarations) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
		A3(
			$author$project$Css$Internal$joinMap,
			function (_v0) {
				var selector = _v0.a;
				var pairs = _v0.b;
				return selector + (' {\n' + (A3(
			...
			$elm$core$Dict$toList(
				$author$project$Css$Internal$toPairsDict(declarations))));
};
var $author$project$Html$Styled$getHashAndString = function (declarations) {
	var maybeDecStr = $author$project$Css$Internal$toString(declarations);
	return A2(
		$elm$core$Maybe$map,
		function (decsStr) {
			return _Utils_Tuple2(
				$elm$core$String$fromInt(
					A2($Skinney$murmur3$Murmur3$hashString, $author$project$Css$Internal$seed, decsStr)),
				decsStr);
		},
		maybeDecStr);
};
...
var $author$project$Html$Styled$folder = F2(
	function (node_, _v11) {
		var children = _v11.a;
		var styleDict = _v11.b;
		var _v12 = A2($author$project$Html$Styled$folderHelper, styleDict, node_);
		var newNode = _v12.a;
		var newStyleDict = _v12.b;
		return _Utils_Tuple2(
			A2($elm$core$List$cons, newNode, children),
			newStyleDict);
	});
var $author$project$Html$Styled$folderHelper = F2(
	function (styleDict, node_) {
		switch (node_.$) {
			case 'Text':
				var str = node_.a;
				return _Utils_Tuple2(
			...
			case 'Node':
				...
				var _v3 = A3(
					$elm$core$List$foldr,
					$author$project$Html$Styled$folder,
					_Utils_Tuple2(_List_Nil, styleDict),
					children);
				var children_ = _v3.a;
				var newStyleDict = _v3.b;
				return _Utils_Tuple2(
					A3($elm$virtual_dom$VirtualDom$node, tag, attributes, children_),
					newStyleDict);
			case 'KeyedNode':
				var tag = node_.a;
				var attributes = node_.b;
			...
			case 'StyledNode':
				...
				var children = node_.d;
				var _v6 = A4(
					$author$project$Html$Styled$folderHelperHelper,
					$author$project$Html$Styled$getHashAndString(declarations),
					attributes,
					children,
					styleDict);
				var newAttributes = _v6.a;
				var _v7 = _v6.b;
				var children_ = _v7.a;
				var newStyleDict = _v7.b;
				return _Utils_Tuple2(
			...
			default:
				...
				var _v8 = A4(
					...
					A2($elm$core$List$map, $elm$core$Tuple$second, children),
					styleDict);
				var newAttributes = _v8.a;
				var _v9 = _v8.b;
				var children_ = _v9.a;
				var newStyleDict = _v9.b;
				return _Utils_Tuple2(
					A3(
						$elm$virtual_dom$VirtualDom$keyedNode,
						tag,
...
var $author$project$Html$Styled$folderHelperHelper = F4(
	function (maybeHashAndString, attributes, nodes, styleDict) {
		if (maybeHashAndString.$ === 'Just') {
			var _v1 = maybeHashAndString.a;
			var hash = _v1.a;
			var decsStr = _v1.b;
			return _Utils_Tuple2(
				A2($author$project$Html$Styled$addClass, hash, attributes),
				A3(
					$elm$core$List$foldr,
					$author$project$Html$Styled$folder,
					_Utils_Tuple2(
						_List_Nil,
						A3($elm$core$Dict$insert, hash, decsStr, styleDict)),
					nodes));
		} else {
			return _Utils_Tuple2(
				attributes,
...
var $author$project$Css$Global$Stylesheet_ = F3(
	function (imports, keyframes, rules) {
		return {imports: imports, keyframes: keyframes, rules: rules};
	});
var $elm$core$List$singleton = function (value) {
	return _List_fromArray(
		[value]);
};
var $author$project$Css$Global$ruleToString = F2(
	function (selector, declarations) {
		return A2(
			$elm$core$Maybe$withDefault,
			'',
			$author$project$Css$Internal$toString(
...
var $author$project$Css$Global$style = A2($elm$virtual_dom$VirtualDom$node, 'style', _List_Nil);
var $author$project$Css$Global$keyframesToStyleNodes = $elm$core$List$map(
	function (_v0) {
		var name = _v0.name;
		var rules = _v0.rules;
		return _Utils_Tuple2(
			'keyframes' + name,
			$author$project$Css$Global$style(
				_List_fromArray(
					[
						...
						'@keyframes ' + (name + (' {\n' + (A3(
							$author$project$Css$Internal$joinMap,
							function (_v1) {
								var selector = _v1.selector;
								var declarations = _v1.declarations;
								return A2($author$project$Css$Global$ruleToString, selector, declarations);
							},
							'\n',
							rules) + '\n}'))))
					])));
...
var $author$project$Css$Global$rulesToStyleNodes = A2(
	$elm$core$Basics$composeR,
	$elm$core$Dict$toList,
	$elm$core$List$map(
		function (_v0) {
			...
			var ruleText = A2($author$project$Css$Global$ruleToString, selector, declarations);
			return _Utils_Tuple2(
				$elm$core$String$fromInt(
					A2($Skinney$murmur3$Murmur3$hashString, $author$project$Css$Internal$seed, ruleText)),
				$author$project$Css$Global$style(
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text(ruleText)
						])));
		}));
var $author$project$Css$Global$toStyleNodesFrom = F2(
	function (statements, stylesheet) {
		toStyleNodesFrom:
		while (true) {
			if (statements.b) {
				var first = statements.a;
				var rest_ = statements.b;
				switch (first.$) {
					case 'Rule':
						var rule_ = first.a;
						var $temp$statements = rest_,
							$temp$stylesheet = _Utils_update(
							stylesheet,
							{
								rules: A3(
									$elm$core$Basics$composeR,
									$elm$core$Dict$insert(rule_.selector),
									$elm$core$Basics$apR(stylesheet.rules),
									A2(
										$elm$core$Maybe$withDefault,
										rule_.declarations,
										A2(
											$elm$core$Maybe$map,
											$elm$core$Basics$append(rule_.declarations),
											A2($elm$core$Dict$get, rule_.selector, stylesheet.rules))))
							});
						statements = $temp$statements;
						stylesheet = $temp$stylesheet;
						continue toStyleNodesFrom;
					case 'Batch':
						var batchedStatements = first.a;
						var $temp$statements = _Utils_ap(batchedStatements, rest_),
							$temp$stylesheet = stylesheet;
						statements = $temp$statements;
						stylesheet = $temp$stylesheet;
						continue toStyleNodesFrom;
					case 'Import':
						var imports_ = first.a;
						var $temp$statements = rest_,
							$temp$stylesheet = _Utils_update(
							stylesheet,
							{imports: imports_});
						...
						continue toStyleNodesFrom;
					default:
						var keyframes_ = first.a;
						var $temp$statements = rest_,
							$temp$stylesheet = _Utils_update(
							stylesheet,
							{
								keyframes: A2($elm$core$List$cons, keyframes_, stylesheet.keyframes)
							});
						statements = $temp$statements;
						stylesheet = $temp$stylesheet;
						continue toStyleNodesFrom;
				...
				return ($elm$core$List$isEmpty(stylesheet.imports) ? $elm$core$Basics$identity : $elm$core$List$cons(
					A3(
						$elm$core$Basics$composeR,
						$author$project$Css$Global$style,
						$elm$core$Tuple$pair('imports'),
						$elm$core$List$singleton(
							$elm$virtual_dom$VirtualDom$text(
								A3(
									$author$project$Css$Internal$joinMap,
									...
									stylesheet.imports))))))(
					_Utils_ap(
						$author$project$Css$Global$keyframesToStyleNodes(stylesheet.keyframes),
						$author$project$Css$Global$rulesToStyleNodes(stylesheet.rules)));
			}
		}
	});
var $author$project$Css$Global$toStyleNodes = function (statements) {
	return A2(
		$author$project$Css$Global$toStyleNodesFrom,
		statements,
		A3($author$project$Css$Global$Stylesheet_, _List_Nil, _List_Nil, $elm$core$Dict$empty));
};
var $author$project$Css$Global$toStyleNode = F2(
	function (statements, styleNodes) {
		return A3(
			$elm$virtual_dom$VirtualDom$keyedNode,
			'style',
			_List_Nil,
			_Utils_ap(
				$author$project$Css$Global$toStyleNodes(statements),
				styleNodes));
	});
...
var $author$project$Html$Styled$toStyleNodes = A2(
	$elm$core$Basics$composeR,
	$elm$core$Dict$toList,
	$elm$core$List$map(
		function (_v0) {
			var hash = _v0.a;
			var ruleTemplate = _v0.b;
			return _Utils_Tuple2(
				hash,
				A3(
					...
					_List_fromArray(
						[
							$elm$virtual_dom$VirtualDom$text(
							A3($elm$core$String$replace, $author$project$Css$Internal$tmpClass, '._' + hash, ruleTemplate))
						])));
		}));
var $author$project$Html$Styled$withStyles = F2(
	function (statments, nodes) {
		var _v0 = A3(
			$elm$core$List$foldr,
			$author$project$Html$Styled$folder,
		...
		return A2(
			$elm$core$List$cons,
			A2(
				$author$project$Css$Global$toStyleNode,
				statments,
...
var $author$project$Main$view = function (model) {
	return {
		body: A2(
			$author$project$Html$Styled$withStyles,
			_List_fromArray(
				[
					$author$project$Css$Global$body(
					_List_fromArray(
						[
							$author$project$Css$margin('0'),
							$author$project$Css$display('grid'),
							$author$project$Css$justifyItems('center'),
							$author$project$Css$font('sans-serif 1.5rem')
						])),
					$author$project$Css$Global$td(
					_List_fromArray(
						[
							$author$project$Css$padding('0')
						]))
				]),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Css$borderRadius($author$project$Design$tableRadius),
							A2(
							$author$project$Css$mapSelector,
							function (c) {
								return c + ' tr';
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$author$project$Css$borderBottomLeftRadius($author$project$Design$tableRadius)
																])),
															A2(
															$author$project$Css$mapSelector,
															function (c) {
															...
															_List_fromArray(
																[
																	$author$project$Css$borderBottomRightRadius($author$project$Design$tableRadius)
																]))
														]))
												]),
											_List_Nil,
